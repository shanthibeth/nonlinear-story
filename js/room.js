...
$(document).ready(function() {
    ...
    window.onload = function() {
        ...
        $("#screentext").typed({
            strings: ["Welcome to the " + color + " Room.^300  <br><br> " + screenWords + "<br><br> <button onclick=closeScreen() id=closescreen>Click to Close</button>"],
            contentType: 'html',
            typeSpeed:20 
            // 20
    ...
    window.onresize = function(){
        ...
        var x4 = x1;
        var y4 = y3;
        var posted = document.getElementById("posted-sign");
        posted.coords = x1 + ", " + y1+ ", " + x2+", "+y2 + "," + x3 + ", " + y3+ ", " + x4+", "+y4;
        ...
        var x4 = .85 * imgWidth;
        var y4 = .549 * imgHeight;
        var far = document.getElementById("far-sign");
        far.coords = x1 + ", " + y1+ ", " + x2+", "+y2 + "," + x3 + ", " + y3+ ", " + x4+", "+y4;
        ...
        var x4 = 1 * imgWidth;
        var y4 = .64725 * imgHeight;
        var close = document.getElementById("close-sign");
        close.coords = x1 + ", " + y1+ ", " + x2+", "+y2 + "," + x3 + ", " + y3+ ", " + x4+", "+y4;
